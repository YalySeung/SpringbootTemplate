...
import com.springboottemplate.springboottemplate.dto.sample.SampleDto;
import com.springboottemplate.springboottemplate.dto.sample.SampleMapper;
import com.springboottemplate.springboottemplate.dto.sample.SampleRequest;
...
public class SampleController {
    ...
    @PostMapping
    public ResponseEntity<BaseResponse<SampleDto>> createSample(@Valid @RequestBody SampleRequest request) {
    ...
    public ResponseEntity<BaseResponse<SampleDto>> updateSample(
            @Parameter(description = "샘플 ID", example = "1") @PathVariable Long id,
            @Valid @RequestBody SampleDto request) {
